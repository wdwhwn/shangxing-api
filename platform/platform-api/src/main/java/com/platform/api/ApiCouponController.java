...
public class ApiCouponController extends ApiBaseAction {
     ...
     *
     * @param loginUser
     * @param coupon_number 优惠券号码
     * @return
     */
    @ApiOperation(value = "领券优惠券")
    @PostMapping("exchange")
    public Object exchange(@LoginUser UserVo loginUser,String coupon_number) {
    ...
    @ApiOperation(value = "领券优惠券")
    @PostMapping("newuser")
    public Object newuser(@LoginUser UserVo loginUser,String phone,String smscode) {
//        JSONObject jsonParam = getJsonRequest();
        //
