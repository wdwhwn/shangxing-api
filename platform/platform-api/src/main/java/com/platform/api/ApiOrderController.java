...
//            orderInfo.final_pay_time = moment("001234", "Hmmss").format("mm:ss")
    ...
    @PostMapping("submit")
    public Object submit(Integer couponId,String type,String postscript,Integer addressId,@LoginUser UserVo loginUser) {
        Map resultObj = null;
        try {
            resultObj = orderService.submit(couponId,type,postscript,addressId, loginUser);
            if (null != resultObj) {
