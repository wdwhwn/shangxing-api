...
public class ApiGoodsController extends ApiBaseAction {
    ...
    /**
     */
    @ApiOperation(value = "类别目录")
    @IgnoreAuth
    @PostMapping(value = "categoryIndex")
    public Object categoryIndex() {
      ...
      List<CategoryVo> categoryVoList=categoryService.queryCategory();
        return toResponsSuccess(categoryVoList);
    }
    /**
     */
    ...
    public Object detail(Integer id, Long referrer,@LoginUser UserVo loginUser) {
        Map<String, Object> resultObj = new HashMap();
        //
...
//        issueParam.put("goods_id", id);
        ...
        collectParam.put("user_id", loginUser.getUserId());
