...
public class ApiOrderService {
    ...
    @Transactional
    public Map<String, Object> submit(Integer couponId,String type,String postscript,Integer addressId, UserVo loginUser) {
...
//        AddressVo addressVo = jsonParam.getObject("checkedAddress",AddressVo.class);
        ...
        if (couponId != null && couponId != 0) {
            ...
            System.out.println("BBBBBBBBBBBBBBBB"+couponVo+"BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB");
            if (couponVo != null && couponVo.getCoupon_status() == 1) {
                couponPrice = couponVo.getType_money();
                System.out.println("AAAAAAAAAAAAAAAAAA"+couponPrice+"AAAAAAAAAAAAA");
            }
        }
