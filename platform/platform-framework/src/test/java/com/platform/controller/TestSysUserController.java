...
public class TestSysUserController extends BaseSpringTestCase {
    ...
    @Autowired
    OcMemberService ocMemberService;
   ...
   /* @Test
    public void querySysUserList1() {
        List<OcMemberEntity> ocMemberEntities = ocMemberService.queryList(null);
        System.out.println(ocMemberEntities);
    }*/
